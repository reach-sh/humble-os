...
const ExodusLogo = ({
  ...
  <svg
    ...
    height={height}
    viewBox={viewBox}
    style={{ padding: '6px', margin: '2px 4px 0 4px' }}
    fill='none'
  ...
  >
    ...
    <g mask='url(#mask0_68_536)'>
      <rect
        ...
        width={224.25}
        height={230}
        fill='url(#paint4_linear_68_536)'
      />
    </g>
    <defs>
      <linearGradient
        id='paint0_linear_68_536'
        x1={194.938}
        y1={245.813}
        x2={129.33}
        y2={-25.2585}
